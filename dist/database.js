 ...
 */
export async function calculateSkillHash(skillPath) {
 ...
 */
export async function checkKnownBad(skillHash) {
    try {
 ...
 */
export async function reportMalicious(skillHash, findings) {
    try {
