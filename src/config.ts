 ...
 */
export async function loadConfig(): Promise<ClawGuardConfig> {
  try {
 ...
 * Save configuration
 */
export async function saveConfig(config: ClawGuardConfig): Promise<void> {
 ...
 */
export async function runSetupWizard(): Promise<ClawGuardConfig> {
  console.log('');
  console.log('╔════════════════════════════════════════════════════════════════╗');
